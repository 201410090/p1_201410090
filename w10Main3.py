...
for i in range(len(list_values)):
    if list_values[i]>=24:
        print list_keys[i] +' '+str(list_values[i])

print "_______________________________________________________"

George_W_Bush = ["Vice President Cheney, Mr. Chief Justice, President Carter, President Bush, President Clinton, reverend clergy, distinguished guests, fellow citizens: ",
